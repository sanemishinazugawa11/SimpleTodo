...
const Navbar: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className=" bg-neutral-950/80 backdrop-blur-md text-white rounded-full z-50 border-[0.5px] flex justify-evenly items-center border-x-slate-600 border-y-neutral-700 fixed top-10 left-1/2  w-[8n0%] sm:w-[50%]  -translate-x-[50%] h-[10vh] ">
